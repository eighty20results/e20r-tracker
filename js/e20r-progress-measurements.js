...
(function ($) {
    var progMeasurements = {
        ...
        init: function (self, attrs) {
            ...
            $class.profiletabs = $('div#profile-tabs.ct');
            $class.statustabs = $('div#status-tabs.ct');

            $class.wPlot = null;
            $class.gPlot = null;
            $class.statPlot = [];
            $class.$loadStatsBtn = $(".e20r-workout-statistics-loader");
            $class.$isAdmin = false;
            ...
            if ($class.clientId === null) {
                ...
                $class.$btnRow = $(".e20r-data-choices");
                $class.$hClientId = $("#hidden_e20r_client_id");

                $class.$adminLoadBtn = $("#e20r-load-data");

                $class.$detailBtn = $("#e20r-client-info");
                $class.$complianceBtn = $("#e20r-client-compliance");
                $class.$assignBtn = $("#e20r-client-assignments");
                $class.$measureBtn = $("#e20r-client-load-measurements");

                $class.$clientInfo = $class.$detailBtn;
                $class.$clientAssignmentsInfo = $("#e20r-progress-assignments");
                $class.$clientAchievementsInfo = $("#e20r-progress-accomplishments");
                $class.$clientActivityInfo = $("#e20r-progress-activities");
                $class.$clientMeasurementInfo = $('#e20r-progress-measurements');

                $class.clientMsgForm = $("div#e20r-client-contact");
                $class.clientMsgHistory = $("table.e20r-client-message-history-table");

                $class.$clientMessageTab = $("#ui-id-5");
                $class.$clientMessageForm = $("#e20r-client-contact");
                ...
                $.bindEvents({
                    ...
                    events: {
                        change: function (self, e) {
                            $("div.status-tabs").addClass("startHidden");
                            self.loadMemberList();
                        }
                    }
                });
                    ...
                    $.bindEvents({
                        ...
                        events: {
                            click: function (self, e) {
                                ...
                                var $exercise_id = $(this).closest('.e20r-exercise-statistics').find('.e20r-workout-statistics-exercise_id').val();
                                var $client_id = $('#user_id').val();
                                var $graph = $(this).closest('.e20r-exercise-statistics').find('div#exercise_stats_' + $exercise_id);
                ...
                $(".exercise-stats-container").each(function () {
                    $(this).hide();
                });
        ...
        manage_overlay: function (box) {
            ...
            cWindow.find('.close').unbind('click').on('click', function (e) {
                ...
                var interview = $('div#profile-tabs.ct').data('codetabs');
                mask.hide();
                cWindow.hide();
        ...
        _hide_client_info: function () {
            $('div.status_tabs').hide();
        },
        _show_client_info: function () {
            $('div.status_tabs').show();
        },
        _resize_chart: function () {
            ...
            var $tabspace = $('#e20r-progress-measurements').width() * 0.87;
            ...
            if (($tabspace > 0) &&
                ...
                $("#weight_chart").width($tabspace);
                $('#girth_chart').width($tabspace);
...
//        $class.loadClientMessageHistory(id);
            ...
            $("div#status-tabs").removeClass("startHidden");
        ...
        loadAchivementsData: function ($clientId) {
            ...
            if (true === $class.$isAdmin) {
                ...
                $class._loadInfo($clientId, 'achievements', $("#e20r-progress-achievements"));
            }
        },
        loadAssignmentData: function ($clientId) {
            ...
            if (true === $class.$isAdmin) {
                ...
                $class._loadInfo($clientId, 'assignments', $("#e20r-progress-assignments"));
            }
        },
        loadActivityData: function ($clientId) {
            ...
            if (true === $class.$isAdmin) {
                ...
                $class._loadInfo($clientId, 'activities', $("#e20r-progress-activities"));
            }
        },
        get_tinymce_content: function () {
            ...
            if ($("#wp-content-wrap").hasClass("tmce-active")) {
                ...
                return $('#e20r-message-content').val();
            }
        },
        loadClientMessages: function ($clientId) {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    'e20r-tracker-clients-nonce': $('#e20r-tracker-clients-nonce').val(),
                    'client-id': $clientId
                },
                beforeSend: function () {
                ...
                complete: function () {
                    ...
                    // $("div#wp-content-editor-container").hide();

                    wp.editor.initialize('e20r-message-content', settings);

                    $('input#e20r-send-email-message').on('click', function () {
                    ...
                    var $datePicker = $('#e20r-tracker-send-message-datetime');
        ...
        sendMessage: function () {
            ...
            var $clientId = $("input#e20r-send-to-id").val();

            var $when = $('#e20r-tracker-send-message-datetime').val();
            ...
            var $data = {
                ...
                'e20r-tracker-clients-nonce': $('#e20r-tracker-clients-nonce').val(),
                'subject': $('input#e20r-email-subject').val(),
                'when-to-send': $when,
                'e20r-message-content': $class.get_tinymce_content(),
                'email-to': $("input#e20r-send-message-to").val(),
                'email-cc': $("input#e20r-send-message-cc").val(),
                'email-from': $("input#e20r-email-from").val(),
                'email-from-id': $("input#e20r-send-from-id").val(),
                'email-from-name': $("input#e20r-email-from-name").val()
            };
        ...
        loadActivityStats: function ($clientId, $exercise_id, $graph) {
            ...
            var $data = {
                ...
                'e20r-weight-rep-chart': $('#e20r-weight-rep-chart').val(),
                'wh_h_dimension': $("#wh_h_dimension").val(),
                'wh_w_dimension': $("#wh_w_dimension").val(),
                'wh_h_dimension_type': $("#wh_h_dimension_type").val(),
                'wh_w_dimension_type': $("#wh_w_dimension_type").val(),
                client_id: $clientId,
                ...
                success: function (data) {
                    ...
                    if ((data.html !== '')) {
                        ...
                        if ((typeof $max_weight !== 'undefined') && ($max_weight[0].length > 0)) {
                            ...
                            $class.statPlot[$plot_target] = $.jqplot($plot_target, [$max_weight, $reps], {
        ...
        loadMeasurementData: function ($clientId) {
            ...
            var $class = this;
            var nonce_element = $('#e20r_tracker_client_detail_nonce');
            $class.body.addClass("loading");
            ...
            $.ajax({
                ...
                data: {
                    ...
                    'h_dimension': $("#h_dimension").val(),
                    'w_dimension': $("#w_dimension").val(),
                    'h_dimension_type': $("#h_dimension_type").val(),
                    'w_dimension_type': $("#w_dimension_type").val(),
                    client_id: $clientId
                },
                beforeSend: function () {
                    $class.body.addClass('loading ');
                ...
                success: function (data) {
                    ...
                    if ((data.html !== '')) {
                        ...
                        if ((typeof data.weight !== 'undefined') && (data.weight.length > 0)) {
                            ...
                            $class.wPlot = $.jqplot('weight_chart', [data.weight], {
                        ...
                        if ((typeof data.girth !== 'undefined') && (data.girth.length > 0)) {
                            ...
                            $class.gPlot = $.jqplot('girth_chart', [data.girth], {
                                title: 'Total Girth',
                                gridPadding: {right: 35},
                                seriesDefaults: {
                                    showMarker: false,
                ...
                complete: function () {
                    ...
                    $("#e20r-measurement-table").delegate('td', 'mouseover mouseleave', function (e) {
                        if (e.type === 'mouseover') {
