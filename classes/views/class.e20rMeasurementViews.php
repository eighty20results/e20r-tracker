...
/*
                    ...
                    if ($tabs.length !== 0) {
                        ...
                        if ( 'undefined' !== typeof $tabs.data('codetabs') ) {

                            var $innertabs = $tabs.data('codetabs').ev;
                            $innertabs.on('selectID', function ($e, $id) {

                                console.log("Inner tab # " + $id + " selected/clicked");
                                progMeasurements._tab_selected($e, $id);
                            });
                        }
                    }
**/
