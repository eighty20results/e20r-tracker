...
class Program extends Settings {
	 ...
	 * @return array
	 */
	public function get_users_in_programs() {
	...
	public function configure_startdate( $program_id, $userId ) {
		...
		if ( isset( $e20r_user_startdates[ $userId ] ) && $e20r_user_startdates[ $userId ] === $currentProgram->startdate ) {
			E20R_Tracker::dbg( "Program::configure_startdate() - Using cached date as the start: {$e20r_user_startdates[$userId]} for {$userId}" );
