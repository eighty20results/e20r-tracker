...
* BUG FIX: Updating CPT caused filter/action loop.
* ENHANCEMENT: Using static method Tracker::add_save_actions()
* ENHANCEMENT: Using static method Tracker::remove_save_actions()
