(function() {
    ...
    window.googleAnalytics = function() {
        if (false === boolNotNull(window.TRACK_ANALYTICS)) {
            return;
        }
        ...
        window._gaq.push(['_setAccount', 'UA-2302017-1']);
...
(function() {
    ...
    jQuery.getScript('http://www.precisionnutrition.com/members/js/jquery.scrollTo-min.js', function() {
        setTimeout(function() {
...
// someone put onload="rankingsPush()" to the body of every page. This fixes the errors
